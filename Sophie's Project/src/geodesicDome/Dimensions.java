...
public class Dimensions {
	...
	// above is a link which has a precise ratio between the two lengths of wood needed.
	// Work in metres.
	...
	public static ArrayList<Double> anglesOfIsosceles(double hypotenuse, double base) {
		...
		System.out.println("Angle between two EQUAL length sides of the triangle is: " + Math.toDegrees(ang1)+"\u00b0");
		double ang2 = Math.acos(((c * c) + (a * a) - (b * b)) / (2 * (c * a)));
		System.out.println("Angle between two UNEQUAL length sides of the triangle is: " + Math.toDegrees(ang2)+"\u00b0");
		ArrayList<Double> angles = new ArrayList<Double>();
		angles.add(ang1);
		angles.add(ang2);
		return angles;
	}
	// Works out the diameter of decagon base and prints this and the height of domey.
